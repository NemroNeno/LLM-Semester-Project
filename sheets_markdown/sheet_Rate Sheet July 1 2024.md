...
|-|-|-|-|-|-|-|-|-|
||||||||||
|Indicative Profit Rates<br/>(For Conventional Deposit Products on “Per Annum” basis)<br/>Effective July 1st, 2024|||||||||
||||||||||
||||||||||
||||||||||
||||||||||
...
||||||||||
|https\://askaribank.com/AKBLUploads/uploads/SOC-Conv-English.pdf|||||||||
